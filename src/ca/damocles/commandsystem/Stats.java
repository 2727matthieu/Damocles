...
public class Stats implements CommandExecutor{
	...
	public String getExpBar(ca.damocles.accountsystem.Character character){
	...
	public void openBook(Player player, ca.damocles.accountsystem.Character character){
		...
		page1.add(new FancyMessage(character.getUsername()+"'s Stats")
			...
			ChatColor.GRAY+"Base Magic Damage: "+character.getMagicalDamage()
				...
				+ChatColor.GRAY+"Clansmen: "+ new ca.damocles.clansystem.Clan(character.getClan()).getClansmen().size())
				.then("\n")
